...
class Game:
    ...
    def _draw_cards(self):
        ...
        for i, pc in enumerate(player_cards):
            if self.player_cards[i]['Reveal'] == True:
                self.player_card_group.add(self.player_cards[i]['Front'])
            elif pc.rect.collidepoint(self.mouse_x, self.mouse_y) and self.card_selected:
        ...
        for i, pc in enumerate(opponent_cards):
            if self.opponent_cards[i]['Reveal'] == True:
